...
export class V2TwoPassCampaignForm extends CampaignForm {
	form
	...
	getStepThree(self) {
		return {
			"Action Page": {
				description:
					"The Action Page is what your contacts will be sharing with their network.",
				questions: [
					{
						name: "defaultType",
			...
			"Text Messages": {
				questions: [
					...
					},
					{
						description: "",
						displayName:
							"Message from the Forwarder to the Recipient",
						limitTo: 280,
						name: "pRMessage",
...
export const module = {
	key: "V2TwoPassCampaignForm",
	fn: V2TwoPassCampaignForm,
}
