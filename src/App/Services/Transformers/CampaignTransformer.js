...
export class CampaignTransformer {
	...
	setActionPageFormFields(form, campaign) {
		// Action Page Loading
		console.log(campaign, campaign.action_page, campaign.action_page.site)
			...
			.then(function (x) {
				...
				_.forEach(
					...
					function (button, i) {
						...
						console.log("working on button", name, actionButton)
...
export const module = {
	key: "CampaignTransformer",
	fn: CampaignTransformer,
}
