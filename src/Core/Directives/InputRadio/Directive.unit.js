...
describe("Directive \"inputRadio\"", function () {
	...
	it("can be created", function () {
		...
		expect(element.html()).toContain(
			"<input ng-model=\"model\" ng-change=\"change\" ng-value=\"value\" type=\"radio\" name=\"\" ng-required=\"required\" class=\"ng-pristine ng-untouched ng-empty ng-valid ng-valid-required\">"
		)
	})
})
