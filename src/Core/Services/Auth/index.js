...
AuthService.prototype.assignRoles = function (data) {
	...
	_.forEach(
		...
		_.bind(function (company) {
			promises.push(
				this.$api
					.show("users", data.user.id)
					.index("roles", {
...
AuthService.prototype.login = function (email, password) {
	...
	promise
		.then(_.bind(this.assignUser, this))
...
AuthService.prototype.loadRole = function (companyId) {
	...
	return self.RoleService.indexFor("users", this.getUserId(), {
...
AuthService.prototype.getRole = function (companyId) {
	companyId =
		companyId ||
		_.get(this, "$stateParams.companyId", this.getDefaultCompanyId())
