...
namespace lt {
	export class V1ReferralThreadCampaignForm extends CampaignForm {
		...
		build(): ICampaignFormForm {
			...
			form["Step 3"] = <ICampaignFormGroup>{
				"Text Messages": <ICampaignFormSubGroup>{
					questions: [
						...
						{
							name:"pRMessage",
							displayName:"Message from Person Giving Intro to Referrals",
							description:"",
			...
			form["Step 4"] = <ICampaignFormGroup>{
				"Incentive": <ICampaignFormSubGroup>{
					questions: [{
						...
						description:"A message to incentivize your contacts to share this action page.",
						value:"",
						type:"textarea",
						depend:{
							name: "incentiveChoice",
						...
						description: "An image or video to describe your incentive",
						value:null,
						type:"select",
						depend:{
							name: "incentiveChoice",
						...
						required: false,
						valid: function () {
							return this.value === "App\\Models\\Video" || this.value === "App\\Models\\File";
						},
					}, {
						...
						required: function () {
							return self.getFieldValue("incentiveMediaType") == "App\\Models\\File";
						},
					}, {
						...
						required: function () {
							return self.getFieldValue("incentiveMediaType") == "App\\Models\\Video";
						},
					}]
				}
			};
	...
	angular.module("lt.app").service("V1ReferralThreadCampaignForm", V1ReferralThreadCampaignForm);
}
