(function (angular, _) {
	...
	angular.module("lt.core").directive("placeholderInsert", ["$textInsert", "$popup", function ($textInsert, $popup) { 
		return {
			restrict: "A",
			templateUrl: "components/placeholder-insert/index.html",
			scope : {
			...
			link: function ($scope) {
				...
				function insert (text) {
					return $textInsert.insert(angular.element($scope.selector)[0], "["+text+"]");
				}
				 ...
				 */
				function openHelp () {
					$popup.info("What are Placeholders?", 
