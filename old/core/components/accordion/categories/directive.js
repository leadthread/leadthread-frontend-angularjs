(function (angular, _) {
	...
	angular.module("lt.core").directive("categoriesDirective", ["$api", "$q", "Prompt", function ($api, $q, Prompt) {
		return {
			restrict:"E",
			...
			link: function ($scope) {
						...
						"auto": [
							{
								...
								ready:false,
								img:11,
								fingerprint:"e646ac36fa3b7a66d524be400a965decfe1a2bea1c8093ec60fb1786e8e1b489"
							},
							{
								prompt:"Do you know anybody that is expecting a child or will soon need a larger car?",
								ready:false,
								img:1,
								fingerprint:"3bd2f8589d14c162f2ae9c83a6f04923597cb4839ab3b840d28b17ba9ada1ec0"
							},
							{
								prompt:"Who do you know, that would really benefit from having their smartphone connected car?",
								ready:false,
								img:6,
								fingerprint:"19f1f327b1670b731fb44fb6d39db33cbd9891ad018d305d07e7c7eae530e7cc"
							},
							{
								...
								ready:false,
								img:7,
								fingerprint:"5adcaffee462846738da34c0ca3c6f389b13dc8d41b059cfb1309372f46f9118"
							},
							{
								prompt:"Who do you know, that could benefit from more horse power, for towing their toys?",
								ready:false,
								img:8,
								fingerprint:"e73690ccfbabddf1cd19efbfd32337f6c3d572adca61d670f1976d08751c5fc7"
							}
						],
						// Mortgage
						"home": [
						...
						"solar": [
							{
								...
								ready:false,
								img:4,
								fingerprint:"80a5384b1f14154c08f58984b6126986e3ef789be23a07f312461b2f70c3a265"
							},
							{
								prompt:"Do you know anybody who has an “off-grid” home or cabin?",
								ready:false,
								img:5,
								fingerprint:"1c1027ec5caa246a55c373ba12c3006a5f1f9e345f9759eda3fda825b74fab86"
							},
							{
								prompt:"Who do you know, that is always looking for clever ways to save money?",
								ready:false,
								img:11,
								fingerprint:"4f236879d81c8c3af1b74c5f8403099abb9c26bb2553be080e7e38de85333bed"
							},
							{
								prompt:"Do you know any “hobbyist” types who are often involved with new technologies?",
								ready:false,
								fingerprint:"45f45758247f0783ae53531da6a3e9e149e75178b7007db389bff410cd6504c7",
								img:2
							},
						]
					};
				...
				function getImg (opt) {
					var arr = [];
					arr.push($q(function (resolve) {
						$api.index("files", {fingerprint: opt.fingerprint}).exec().then(function (newOpt) {
				...
				function select (opt) {
					...
					if (!(opt instanceof Prompt)) {
						res = new Prompt(opt.prompt, opt.img, "/files/"+opt.fingerprint+"/thumb/480");
					}
					$scope.prompt = res;
					$scope.cat = null;
					$scope.option.chosen = [];
