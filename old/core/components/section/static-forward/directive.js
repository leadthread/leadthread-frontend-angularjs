(function (angular, _) {
	...
	angular.module("lt.core").directive("sectionStaticForward", ["$placeholder", "$popup", "EventService", function ($placeholder, $popup, EventService) {
		return {
			restrict: "A",
			...
			link: function ($scope, $el) {
				...
				function init () {
					$scope.model.text = !_.isEmpty($scope.model.text) ? $scope.model.text : "Share Now";
					$scope.parse = parse;
					$scope.goNext = goNext;
				...
				function getButtonStyle () {
					...
					style["border"] = $scope.model.button_border_width+"px solid "+$scope.model.button_border_color;
