(function (angular) {
	 ...
	 */
	StorageProxy.prototype.getItems = function () {
		return this.data;
	};
	 ...
	 */
	StorageProxy.prototype.setItem = function (key, value) {
		this.data[key] = value;
	};
	...
	StorageService.prototype.getDriver = function (type) {
		var proxy = function () {
			console.warn(type+" is not supported or doesnt have enough space available! Using StorageProxy.");
	...
	angular.module("lt.core").service("$localStorage", [function () {
		return new StorageService("localStorage");
	}]);
	angular.module("lt.core").service("$sessionStorage", [function () {
		return new StorageService("sessionStorage");
	}]);
	angular.module("lt.core").service("$proxyStorage", [function () {
