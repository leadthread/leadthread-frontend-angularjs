angular.module("lt.core").controller("PopupController",  ["options", "$scope", "$timeout", "$window", "$uibModalInstance", "$q", "$sce", "$auth", function (options, $scope, $timeout, $window, $uibModalInstance, $q, $sce, $auth) {
	"use strict";
	var okTimeout;
