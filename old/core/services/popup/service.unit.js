...
describe("popup", function () {
	...
	it("calls single function", function () {
		$popup.single("test", "test", "favorites", "what is your favorite", "input", "text", null, null, null)
			.then(function (resp) {
				expect(resp).toEqual({
					form: {
						key:"test",
	...
	it("calls input function", function () {
		$popup.input("test", "test", "favorites", "what is your favorite", null, null)
			.then(function (resp) {
				expect(resp).toEqual({
					form: {
						key:"test",
	...
	it("calls tel function", function () {
		$popup.tel("test", "test", "favorites", "what is your favorite")
			.then(function (resp) {
				expect(resp).toEqual({
					form: {
						key:"test",
	...
	it("calls textarea function", function () {
		$popup.textarea("test", "test", "favorites", "what is your favorite")
			.then(function (resp) {
				expect(resp).toEqual({
					form: {
						key:"test",
	...
	it("calls select function", function () {
		$popup.select("test", "test", "favorites", "what is your favorite", ["Red", "Pizza", "soft tissue"])
			.then(function (resp) {
				expect(resp).toEqual({
					form: {
						key:"test",
