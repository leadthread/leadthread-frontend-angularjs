(function (angular, _) {
	...
	PopupService.prototype.form = function (form, prompt, showCopyPasteHelper, size) {
	 ...
	 */
	PopupService.prototype.single = function (key, value, prompt, label, type, subtype, choices, headers, minlength, maxlength) {
		return this.form([
			{type: type, subtype: subtype, label: label, key: key, value: value, required: true, choices: choices, headers: headers, minlength: minlength, maxlength: maxlength},
		], prompt);
	};
	 ...
	 * @param  {integer}	maxlength maximum character length of value
	 */
	PopupService.prototype.input = function (key, value, prompt, label, minlength, maxlength) {
		return this.single(key, value, prompt, label, "input", "text", null, null, minlength, maxlength);
	};
	...
	PopupService.prototype.checkbox = function (key, value, prompt, label) {
		return this.single(key, value, prompt, label, "input", "checkbox", null, null, null, null);
	};
	 ...
	 * @param  {integer}	maxlength maximum character length of value
	 */
	PopupService.prototype.textarea = function (key, value, prompt, label, minlength, maxlength) {
		return this.single(key, value, prompt, label, "textarea", null, null, null, minlength, maxlength);
	};
	...
	PopupService.prototype.copy = function (model, targets, target) {
		return this.openCopyModal({ model: model, targets: targets, target: target||null });
	};
	...
	angular.module("lt.core").service("$popup", ["$uibModal", "$q", PopupService]);
